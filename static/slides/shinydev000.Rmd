...
# The Shiny-verse Takes Shape

Wealth of packages built by Shiny developers/users
...
* Share techniques, snippets, practical advice gained from my use of `shiny`
* Explore fascinating uses of `shiny` in the `r fa_r_project()` community
* Hands-on videos illustrating Shiny apps and concepts in action
]
